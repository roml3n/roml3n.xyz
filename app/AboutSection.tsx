...
export const AboutSection = () => {
  return (
    ...
    >
      <div className="w-[90%] md:w-[80%] max-w-7xl grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 grid-rows-[auto_auto_auto_auto] md:grid-rows-[auto_auto_auto] auto-rows-min gap-4 md:gap-2">
        <div className="flex flex-col gap-6 md:gap-16 lg:gap-48 col-span-4 lg:col-span-5 row-span-1 col-start-1 row-start-1 h-fit mr-6">
          ...
          <h6 className="w-full h6">
            ...
            nearly every field in computing. <br /> <br /> The only thing I
            didn&apos;t try was running physics simulations; because I
            couldn&apos;t sneak a quantum computer into my bedroom without my
            mum noticing. <br /> <br /> When I&apos;m not staring longingly at a
            laptop screen, you&apos;ll find me staring even more longingly at my
            phone&apos;s screen, and when I&apos;m not doing that either,
            I&apos;d be exploring the city of Nairobi, or Los Santos, playing
