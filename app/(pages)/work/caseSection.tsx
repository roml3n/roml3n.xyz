...
const CaseSection = ({
  ...
  return (
    <section
      className={`w-full grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-4 md:gap-x-6 gap-y-9 md:gap-y-16 col-span-4 md:col-span-8 lg:col-span-12 ${className}`}
    >
      {(title || description) && (
