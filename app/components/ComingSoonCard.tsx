...
export const ComingSoonCard: React.FC<{
  ...
  return (
    <div className="relative flex flex-col shrink-0 grow-0 justify-between w-full h-fit rounded-2xl gap-4 overflow-hidden border border-solid border-fullgrey/10 bg-[E8E6F0]">
      ...
      <div className="relative w-full h-[457px] bg-black/30 rounded-ss-2xl my-0 mr-0 ml-6" />

      {/* Caution Cards */}
      <div className="relative h-12 -mb-[80px] bottom-[50%] scale-[105%]">
