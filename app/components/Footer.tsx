...
const Footer = () => {
  return (
    <footer className="w-full min-h-[34rem] md:min-h-[38rem] overflow-hidden grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 py-10 md:py-12">
      <div className="col-span-4 md:col-span-8 lg:col-span-12 gap-x-6 flex flex-col -gap-6 h-fit">
        ...
        <Image
          ...
          width={2400}
          height={2400}
          className=" pointer-events-none place-self-center flex items-center object-cover"
        />
      </div>
      {/* glow effect */}
