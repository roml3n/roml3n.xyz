...
const Button = ({
  ...
  const variantStyles = {
    primary:
      "pl-6 pr-3 py-3 bg-mainblue !text-fullwhite gap-4 justify-between min-w-[220px]",
    secondary:
      "pl-6 pr-3 py-3 bg-fullwhite border border-solid border-midgrey !text-fullgrey gap-4 justify-between min-w-[220px]",
    ghost:
