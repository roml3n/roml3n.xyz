  ...
  return (
    <section className="w-screen justify-center h-screen bg-[#121212] flex flex-col self-center items-center pt-32 pb-12">
      ...
      <div className="w-[90%] md:w-[80%] max-w-5xl h-full grid grid-cols-12 grid-rows-[auto_auto_1fr] gap-8 ">
        ...
        <div className="row-start-2 row-span-1 col-span-8 w-full flex flex-col gap-6 justify-start items-start opacity-70">
        ...
        <p className="col-start-5 row-start-3 row-span-1 col-span-8 w-full h4 text-left place-self-end !text-fullwhite opacity-70">
